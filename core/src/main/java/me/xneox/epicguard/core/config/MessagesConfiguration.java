...
public class MessagesConfiguration {
  ...
  private String actionbarMonitor = "&cEpicGuardPlus &8// &6%cps% &7connections/s &8| %status%";
  ...
  private String staffAlert = "&8[&cEpicGuardPlus&8] &e{PLAYER} &7({ADDRESS}) was blocked by &c{CHECK}";
  ...
  public static class Command {
    private String prefix = " &cEpicGuardPlus &8// &7";
    ...
    private List<String> mainCommand =
        Arrays.asList(
            "",
            " &6EpicGuardPlus Protection System &8- &7Running version &f{VERSION}",
            "",
    ...
    private List<String> analyzeCommand =
        Arrays.asList(
            "",
            " &6EpicGuardPlus Analysis System &8- &7Results for &f{ADDRESS}",
            "",
            " &eGeographic Data:",
